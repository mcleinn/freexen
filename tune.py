...
def main():
    ...
    parser.add_argument("--refresh", action="store_true", help="Refresh device")
    parser.add_argument("--save", action="store_true", help="Save device")
    parser.add_argument("--calibrate", action="store_true", help="Calibrate device")
    ...
    if not args.device:
        print("Required parameter: --device")
        return
        
    midi_out.open_port(int(args.device))
    ...
    if args.ltn:
        ...
        print("Keyboard data:")
        print(ltn_data)
        send_ltn_message(ltn_data, midi_out)
    ...
    if args.calibrate:
        ...
        midi_out.send_message(sysex_message)
        print("Sent calibration message.")
